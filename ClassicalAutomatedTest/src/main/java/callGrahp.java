...
public class callGrahp {
    ...
    public static void main(String[] args) throws WalaException, IOException {
        ...
        //output the dot file
        findInfectedTestMethods.generateFiles(callGrahp.dotFileForMethod,"MoreTriangle","method");
        findInfectedTestMethods.generateFiles(callGrahp.dotFileForClass,"MoreTriangle","class");
    }
